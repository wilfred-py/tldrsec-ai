 ...
 */
export const STANDARD_FINANCIAL_METRICS = {
 ...
 */
export function isXBRL(content) {
 ...
 */
export function parseXBRL(xbrlString, options = {}) {
    try {
        logger.debug('Parsing XBRL content');
        // Initialize parser options
        const parserOptions = Object.assign(Object.assign({}, DEFAULT_XBRL_OPTIONS), { ignoreAttributes: false, parseAttributeValue: true });
        // Create XML parser
 ...
 * @returns A parsed XBRL document
 */
export function parseXBRLFromBuffer(buffer, options = {}) {
 ...
 */
export async function parseXBRLAsSECFiling(buffer, options) {
    try {
            ...
            if (facts.length > 0) {
                sections.push({
                    ...
                    content: facts.map(fact => {
                        ...
                        let periodInfo = '';
                        if (context === null || context === void 0 ? void 0 : context.period) {
