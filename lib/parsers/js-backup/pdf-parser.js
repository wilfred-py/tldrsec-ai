 ...
 */
export async function parsePDFFromBuffer(buffer, options = DEFAULT_OPTIONS) {
    try {
 ...
 * @returns A promise resolving to the parsed filing sections
 */
export async function parsePDFFromFile(filePath, options = DEFAULT_OPTIONS) {
    try {
 ...
 */
export function getTextContent(section) {
