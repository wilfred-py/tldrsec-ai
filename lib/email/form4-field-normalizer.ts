...
// \u2500\u2500 Post-transaction stake derivation (formerly lib/ai/utils/derive-stake.ts) \u2500\u2500
// Inlined here because the two callers (this file, ../ai/parsers/response-parser.ts)
// were straddling a circular import \u2014 the extracted module imported
// formatNumberWithCommas and NormalizedTransaction back from this file. Merging
// concentrates all Form 4 stake logic behind the same interface as the rest of
// this module and eliminates the load-order fragility documented in the deleted
// file's comment.
