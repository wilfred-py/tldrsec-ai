...
// =============================================================================
// OpenRouter credit-status probe (inlined from a former
// lib/ai/openrouter-credit-monitor.ts wrapper — this handler was the only
// production caller). Fetches remaining LLM credits and renders them for the
// Slack daily report.
// =============================================================================
