 ...
 * every required property. Under strict mode, optional fields are
 * expressed as `type: ['X', 'null']` (see the audit in
 * `__tests__/lib/ai/strict-schema-audit.test.ts` for the wire-shape
 * contract), which means null IS a valid emission - but the model needs
 * to be reminded that null is the *preferred* emission for unknowns.
 ...
 * The other ~25 numeric fields across all 12 schemas have no such
 * pressure.
 *
