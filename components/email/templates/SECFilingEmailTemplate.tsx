...
export default function SECFilingEmailTemplate() {
  return (
    <Card className="mx-auto max-w-[600px] bg-background">
      <CardHeader className="bg-gradient-to-r from-purple-600 via-pink-500 to-pink-400 text-white">
        <h1 className="text-3xl font-bold">SEC Filing Summaries</h1>
        <p className="mt-2 text-lg opacity-90">6/6/2025</p>
      </CardHeader>
      <CardContent>
