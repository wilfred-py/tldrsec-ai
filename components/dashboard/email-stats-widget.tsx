...
export function EmailStatsWidget({
  ...
  return (
    <div className="rounded-2xl border border-[var(--brand-border)] bg-[var(--brand-bg)] p-5 shadow-sm">
      <div className="flex items-center gap-2 text-sm font-medium text-[var(--brand-text-muted)] mb-3">
