...
INSERT INTO "MonitoringThreshold" ("id", "metricName", "thresholdType", "operator", "value", "alertFrequencyMins", "escalationDelayMins", "description") VALUES
('cluid_error_rate_warning', 'error_rate_percent', 'warning', 'gt', 5.0, 15, 60, 'Error rate exceeds 5%'),
('cluid_error_rate_critical', 'error_rate_percent', 'critical', 'gt', 15.0, 5, 30, 'Error rate exceeds 15%'),
('cluid_latency_warning', 'avg_processing_latency_ms', 'warning', 'gt', 30000, 15, 60, 'Average processing latency exceeds 30 seconds'),
('cluid_latency_critical', 'avg_processing_latency_ms', 'critical', 'gt', 60000, 5, 30, 'Average processing latency exceeds 60 seconds'),
('cluid_queue_depth_warning', 'queue_depth', 'warning', 'gt', 100, 15, 60, 'Queue depth exceeds 100 jobs'),
('cluid_queue_depth_critical', 'queue_depth', 'critical', 'gt', 500, 5, 30, 'Queue depth exceeds 500 jobs'),
('cluid_memory_warning', 'memory_usage_mb', 'warning', 'gt', 1024, 15, 60, 'Memory usage exceeds 1GB'),
('cluid_memory_critical', 'memory_usage_mb', 'critical', 'gt', 2048, 5, 30, 'Memory usage exceeds 2GB'),
('cluid_success_rate_warning', 'success_rate_percent', 'warning', 'lt', 95.0, 15, 60, 'Success rate below 95%'),
('cluid_success_rate_critical', 'success_rate_percent', 'critical', 'lt', 85.0, 5, 30, 'Success rate below 85%');