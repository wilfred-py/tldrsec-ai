// Import the ResendClient class using ES Module syntax
import { ResendClient } from './lib/email/resend-client.js';
...
async function testEmailFix() {
  ...
  try {
    ...
    // Since prepareEmailParams is a private method, we'll access it using a workaround
    const params = Object.getPrototypeOf(emailClient).prepareEmailParams.call(emailClient, testEmail);
