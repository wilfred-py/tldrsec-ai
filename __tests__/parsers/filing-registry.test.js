...
describe('Filing Type Registry', () => {
    ...
    test('should get section configuration for a filing type', () => {
        ...
        expect(config === null || config === void 0 ? void 0 : config.importantSections).toContain('Risk Factors');
        expect(config === null || config === void 0 ? void 0 : config.importantSections).toContain('Management\'s Discussion and Analysis');
    });
