...
async function testFilters() {
    ...
    const formTypeFilter = new index_1.FilingFilterBuilder()
        .withFormTypes(['10-K'])
        .build();
    ...
    const dateFilter = new index_1.FilingFilterBuilder()
        .withDateRange({
    ...
    // Test ticker filter
    const tickerFilter = new index_1.FilingFilterBuilder()
        .withTickers(['AAPL'])
        .build();
    ...
    const compositeFilter = new index_1.FilingFilterBuilder()
...
async function testTickerResolver() {
    ...
    const secClient = new index_1.SECDataClient({
        userAgent: 'TLDRSec-AI-Testing contact@example.com'
    });
    const tickerResolver = new index_1.TickerResolver({
        prisma,
        secClient
    });
    try {
