...
const filing_storage_1 = require("./filing-storage");
...
const createMockFilings = (count) => {
    ...
    const filingTypes = ['10-K', '10-Q', '8-K', 'Form4'];
...
async function testFilingStorage() {
    ...
    const tickerResolver = new ticker_service_1.TickerResolver({ prisma });
    const filingStorage = new filing_storage_1.FilingStorage({
        prisma,
        tickerResolver,
        defaultOptions: {
