...
const logger = new logging_1.Logger({}, 'html-parser');
/**
 ...
 */
async function parseHTMLFromUrl(url, options = DEFAULT_OPTIONS) {
    try {
 ...
 */
function parseHTML(html, options = DEFAULT_OPTIONS) {
 ...
 */
function getTextContent($, $element, preserveWhitespace = false) {
