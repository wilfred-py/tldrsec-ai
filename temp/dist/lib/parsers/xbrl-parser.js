...
exports.STANDARD_FINANCIAL_METRICS = exports.DEFAULT_XBRL_OPTIONS = void 0;
exports.isXBRL = isXBRL;
exports.parseXBRL = parseXBRL;
exports.parseXBRLFromBuffer = parseXBRLFromBuffer;
exports.parseXBRLAsSECFiling = parseXBRLAsSECFiling;
const fast_xml_parser_1 = require("fast-xml-parser");
const logging_1 = require("@/lib/logging");
const html_parser_1 = require("./html-parser");
// Initialize logger
const logger = new logging_1.Logger({}, 'xbrl-parser');
 ...
 */
exports.STANDARD_FINANCIAL_METRICS = {
...
function standardizeMetrics(facts) {
    ...
    for (const [standardName, possibleNames] of Object.entries(exports.STANDARD_FINANCIAL_METRICS)) {
...
async function parseXBRLAsSECFiling(buffer, options) {
    try {
        ...
        return {
            ...
            importantSections,
            sections,
            tables: sections.filter(section => section.type === html_parser_1.FilingSectionType.TABLE),
            lists: sections.filter(section => section.type === html_parser_1.FilingSectionType.LIST),
            metadata,
        };
    }
    catch (error) {
